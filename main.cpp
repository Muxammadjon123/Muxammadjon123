...
//     else if (a>80)
    ...
    // else if (ch>='A' && ch<='Z')
    //     cout<<"Output:Uppercase"<<endl;
    // else
    //     cout<<"It is not in alphabet";
    //Problem14
    // float a,b,c,d;
    ...
    // float B=c/a;
    // if (A>B)
    //     cout<<"1st shop has better price";
    // else
    //     cout<<"2nd shop has better price";
    //Problem15
    ...
    // if (distance<=10)
    //     cout<<"("<<x<<","<<y<<")"<<" is inside the circle";
    // else
    //     cout<<"("<<x<<","<<y<<")"<<" is not inside the circle";
    //Problem17
    // float a;
